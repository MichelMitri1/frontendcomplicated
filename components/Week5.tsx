...
function Week5({ expanded, handleChange, setCounter }) {
  return (
    <Accordion
      className={sidebarStyles.sidebar__week2Wrapper}
      expanded={expanded === "panel5"}
      onChange={(event, setExpanded) => handleChange(setExpanded, "panel5")}
    >
      <div className={sidebarStyles.sidebar__week2}>
        ...
        >
          <Typography style={{ display: "flex", gap: "8px" }}>
            <DiCss3Full style={{ fontSize: "24px", color: "grey" }} /> Week 5
          </Typography>
        </AccordionSummary>
      </div>
